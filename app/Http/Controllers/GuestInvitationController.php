...
final class GuestInvitationController extends Controller
{
    ...
    public function sign(
        ...
        // fingerprint built from one) run well past that (short fake values
        // in tests never hit this). Truncate at the wiring layer rather
        // than touch the migration or the frozen action.
